...
public class EmojiManagerTest {
    ...
    @Test
    public void installNormalCategory() {
    ...
    @Test
    public void installNormalEmoji() {
        EmojiManager.install(provider);
    ...
    public void getCategoriesNotInstalled() {
        EmojiManager.getInstance().getCategories();
    }

    @Test(expected = IllegalStateException.class)
    public void findEmojiNotInstalled() {
